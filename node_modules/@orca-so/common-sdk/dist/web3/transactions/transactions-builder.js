...
class TransactionBuilder {
    ...
    async build(userOptions) {
        ...
        if (finalComputeBudgetOption.type === "auto") {
            ...
            const computeBudgetLimit = await (0, compute_budget_1.estimateComputeBudgetLimit)(this.connection, this.instructions, lookupTableAccounts, this.wallet.publicKey, margin);
